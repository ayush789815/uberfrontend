...
const VehiclePanel = ({setVehiclePanel, setConfirmRidePanel}) => {
  return (
    <div>
      ...
      onClick={() => {setVehiclePanel(false)}}><i className="text-3xl text-gray-200 ri-arrow-down-wide-fill"></i></h5>
          ...
          <div onClick={() => {
            ...
            <div className='ml-2 w-1/2'>
              <h4 className='font-medium text-base'>UberGos <span><i className="ri-user-3-fill"></i>4</span></h4>
              <h5 className='font-medium text-sm'>2 min away</h5>
              <p className='font-normal text-xs text-gray-600'>Affordable, cpmpact rides</p>
            </div>
          ...
          <div onClick={() => {
            ...
            <h2 className='text-lg font-semibold'>₹118.lg</h2>
          </div>
    </div>
  )
}
